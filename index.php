...
<body class="vertical-layout vertical-menu 1-column  blank-page blank-page">
			  				...
			  				<div class="card-block">
			  					<form class="form-horizontal form-simple" action="index.html" novalidate>
			  	  					<fieldset class="form-group position-relative has-icon-left mb-0">
			  	  						<input type="text" class="form-control form-control-lg input-lg" id="user_correo" placeholder="Ingrese su correo" autocomplete="new-password" autofocus>
								  	...
								  	<fieldset class="form-group row">
										...
										<div class="col-md-6 col-xs-12 text-xs-center text-md-right"><a href="recover-password.html" class="card-link">Olvidaste tu contraseña?</a></div>
								  	</fieldset>
  	...
  	<script>
  		$("#user_clave").keyup(function (event) {
      		if (event.keyCode === 13) {
        		ValidarUsuario();
      		}
    	});
